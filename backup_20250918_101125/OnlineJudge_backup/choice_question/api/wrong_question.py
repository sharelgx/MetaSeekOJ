...
# from utils.shortcuts import paginate_data  # paginate_data不存在于shortcuts中
from account.decorators import login_required
from ..models import WrongQuestion, ChoiceQuestion, Category
from ..serializers import WrongQuestionSerializer
...
class WrongQuestionAPI(APIView):
    ...
    def get(self, request):
        ...
        return self.success(self.paginate_data(request, queryset, WrongQuestionSerializer))
    ...
    def post(self, request):
        ...
        # 添加或更新错题记录
        wrong_question = WrongQuestion.add_or_update_wrong_question(
            user=request.user,
            question=question,
        ...
        return self.success(WrongQuestionSerializer(wrong_question).data)
