...
from ..serializers import QuestionTagSerializer, QuestionTagCreateSerializer
...
class QuestionTagAPI(APIView):
    ...
    def get(self, request):
        ...
        if popular:
            ...
            return self.success(QuestionTagSerializer(queryset, many=True).data)
        
        return self.success(paginate_data(request, queryset, QuestionTagSerializer))
    
    @super_admin_required
    @validate_serializer(QuestionTagCreateSerializer)
    def post(self, request):
        ...
        if serializer.is_valid():
            tag = serializer.save()
            return self.success(QuestionTagSerializer(tag).data)
...
class QuestionTagDetailAPI(APIView):
    ...
    def put(self, request, tag_id):
        ...
        serializer = QuestionTagCreateSerializer(tag, data=request.data, partial=True)
        if serializer.is_valid():
            tag = serializer.save()
            # 更新题目数量统计
