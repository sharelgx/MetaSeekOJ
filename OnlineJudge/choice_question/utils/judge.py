...
class ChoiceQuestionJudge:
        ...
        try:
            ...
            self.judge_result = {
                ...
                'details': {
                    ...
                    'options_count': len(json.loads(question.options)) if question.options else 0
                }
            }
    ...
    def batch_judge(self, submissions: List[Dict[str, Any]], save_submissions: bool = True) -> List[Dict[str, Any]]:
        ...
        for submission in submissions:
            try:
                question = ChoiceQuestion.objects.get(question_id=submission['question_id'])
    ...
    def _parse_correct_answer(self, answer: str) -> List[int]:
        ...
        try:
            ...
            # 使用通用解析函数
            return parse_answer(answer, 'multiple')  # 使用multiple类型以支持多个答案
