...
class ChoiceQuestionCategoryAPI(APIView):
    """选择题分类API"""
    ...
    def get(self, request):
        ...
        return Response(self.paginate_queryset(request, categories, ChoiceQuestionCategorySerializer))
    ...
    def post(self, request, pk=None):
        ...
        if serializer.is_valid():
            ...
            return Response(ChoiceQuestionCategorySerializer(category).data, status=status.HTTP_201_CREATED)
...
class ChoiceQuestionTagAPI(APIView):
    """选择题标签API"""
    ...
    def get(self, request):
        ...
        return Response(self.paginate_queryset(request, tags, ChoiceQuestionTagSerializer))
...
class ChoiceQuestionAPI(APIView):
    ...
    def get(self, request):
        ...
        return Response(self.paginate_queryset(request, questions, ChoiceQuestionListSerializer))
...
class ChoiceQuestionSubmissionAPI(APIView):
    """选择题提交API"""
...
class ChoiceQuestionStatsAPI(APIView):
    """选择题统计API"""
